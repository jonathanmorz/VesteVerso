...
<head>
    ...
    <title>Camisa Gráfica Verde - VesteVerso</title>
...
<header>
    ...
    <div id="container">
        <div id="imagem-produto">
            <img src="../resources/images/roupas/0015.jpeg" alt="Camisa Manga Longa Feminina" id="img-produto">
        </div>
        <div id="div-conteudo">
            <div id="nome-produto">
                <h2>Camisa Gráfica Verde</h2>
            </div>
