...
<head>
    ...
    <title>Conjunto Suéter Tweed Estampado - VesteVerso</title>
...
<header>
    ...
    <div id="container">
        <div id="imagem-produto">
            <img src="../resources/images/roupas/0023.JPG" alt="Camisa Manga Longa Feminina" id="img-produto">
        </div>
        <div id="div-conteudo">
            <div id="nome-produto">
                <h2>Conjunto Suéter Tweed</h2>
            </div>
