...
<head>
    ...
    <title>Camisa Curta - VesteVerso</title>
...
<header>
    ...
    <div id="container">
        <div id="imagem-produto">
            <img src="../resources/images/roupas/0004.jpeg" alt="Camisa Manga Longa Feminina" id="img-produto">
        </div>
        <div id="div-conteudo">
            <div id="nome-produto">
                <h2>Camisa Manga Curta Feminina</h2>
            </div>
