...
<head>
    ...
    <title>Saia Plissada e Top Cami - VesteVerso</title>
...
<header>
    ...
    <div id="container">
        <div id="imagem-produto">
            <img src="../resources/images/roupas/0025.jpeg" alt="Camisa Manga Longa Feminina" id="img-produto">
        </div>
        <div id="div-conteudo">
            <div id="nome-produto">
                <h2>Saia Plissada e Top Cami</h2>
            </div>
